...
const treeData: TreeNode[] = [
  {
    id: "1",
    name: "Nó de Folha Raiz 1",
    icon: "icon-[lucide--earth]",
    data: { tipo: "folha raiz 1" },
  },
  {
    id: "2",
    name: "Nó de Folha Raiz 2",
    icon: "icon-[lucide--key-round]",
    data: { tipo: "folha raiz 2" },
  },
  {
    id: "3",
    name: "Equipamentos",
  ...
  return (
    <main className="p-8">
      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-lg font-medium mb-4">
            TreeView - Tudo aberto (defaultExpanded=true)
          </h2>
