  ...
  async function fetchContacts() {
    try {
      ...
      if (data.success) {
        ...
        console.error("❌ [PAGE_CONTACTS] Erro ao carregar contatos:", {
          error: data.error,
        });
        toast({
          type: "error",
    ...
    <div className="w-full">
      ...
      <div className="p-6 border-b border-zinc-200 dark:border-zinc-700">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 mt-1">
          Gerencie os contatos da organização
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-700">
            <div className="p-6 border-b border-zinc-200 dark:border-zinc-700">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">
                Lista de todos os contatos da organização
              </p>
            </div>
                ...
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-zinc-600 dark:text-zinc-400 mb-6">
                    {search || statusFilter !== "all"
                      ...
                      : "Comece criando o primeiro contato da organização."}
                  </p>
                  {!search && statusFilter === "all" && (
