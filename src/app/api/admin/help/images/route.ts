...
export async function GET() {
  ...
  try {
    const dir = path.join(process.cwd(), "uploads", "help");
    let files: string[] = [];
    try {
    ...
    console.error("❌ [API_HELP_IMAGES] Erro ao listar imagens:", { error });
