...
export default function ProductDependenciesColumn({
  dependencies,
  loading,
  treeNodes,
  onOpenManagement,
  onEditDependency,
  onDeleteDependency,
}: ProductDependenciesColumnProps) {
  if (loading) {
    ...
    if (onEditDependency) {
      ...
      const dependency: ProductDependency = {
        ...
        children: node.children
          ? convertTreeNodesToDependencies(node.children)
          : undefined,
      };
  ...
  const convertTreeNodesToDependencies = (
    nodes: TreeNode[],
  ): ProductDependency[] => {
        ...
        <div className="p-6" role="tree" aria-orientation="vertical">
          ...
          <div className="flex w-full items-center justify-between gap-2 mb-6">
            <div>
              ...
              <p className="text-sm text-zinc-500 dark:text-zinc-400">
                {dependencies.length}{" "}
                {dependencies.length === 1 ? "categoria" : "categorias"}
              </p>
            </div>
            <Button
              type="button"
              ...
              style="unstyled"
              className="py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800"
          ...
          {treeNodes.length > 0 ? (
            <TreeView
              ...
              showActions={!!(onEditDependency && onDeleteDependency)}
              onEdit={handleEdit}
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-500 mb-4">
                Configure as dependências deste produto
              </p>
              <Button
                type="button"
