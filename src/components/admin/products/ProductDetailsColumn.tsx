...
export default function ProductDetailsColumn({
  contacts,
  problemsCount,
  solutionsCount,
  lastUpdated,
            ...
            <div>
              ...
              <div>
                <span className="text-sm font-medium text-zinc-600 dark:text-zinc-400">
                  {contacts.length} responsáveis técnicos
                </span>
              </div>
            </div>
            <Button
            ...
            <div className="text-center pt-8">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-zinc-600 dark:text-zinc-400 mb-6">
                  Gerencie os contatos responsáveis por este produto para
              ...
              {contacts.map((contact) => (
                <div key={contact.id} className="flex gap-x-2">
                  <div className="size-12 shrink-0">
                    <Avatar src={contact.image} name={contact.name} size="lg" />
                  </div>
