...
export default function DependencyItemFormOffcanvas({
  open,
  onClose,
  isAddingNewItem,
  editFormData,
  ...
  availableIcons,
  isMobile,
}: DependencyItemFormOffcanvasProps) {
  return (
    <Offcanvas
      open={open}
      onClose={onClose}
      ...
      <form className="flex flex-col gap-6" onSubmit={onSubmit}>
        ...
        <div>
          ...
          <Input
            ...
            required
            placeholder="Ex: Servidor Principal, Base de Dados"
          />
        </div>
        ...
        <div>
          ...
          <div
            className={`grid gap-2 ${isMobile ? "grid-cols-6" : "grid-cols-12"}`}
          >
            ...
            {availableIcons.map((iconClass) => (
              <button
                ...
                className={`flex items-center justify-center
								...
								`}
                onClick={() =>
                  setEditFormData((prev) => ({ ...prev, icon: iconClass }))
                }
        ...
        <div>
          ...
          <textarea
            ...
            className="block w-full rounded-lg border-zinc-200 px-4 py-3 text-sm dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-400 dark:placeholder-zinc-500 focus:border-blue-500 focus:ring-blue-500"
            rows={3}
