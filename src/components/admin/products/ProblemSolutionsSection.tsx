...
export function ProblemSolutionsSection({
  ...
  const renderReplies = (
    ...
    const replies = solutions
      .filter((s) => s.replyId === parentId)
      ...
      result.push(
        <div key={reply.id} className={`flex gap-x-2 mt-2 ${marginLeft}`}>
          <div className="size-12 shrink-0">
            <Avatar src={reply.user.image} name={reply.user.name} size="lg" />
          </div>
          <div className="flex flex-col">
            <div className="flex flex-col">
              ...
              {parentMessage && (
                <div className="mb-1 text-xs text-zinc-400 dark:text-zinc-500 italic">
                  ...
                  Resposta a{" "}
                  <span className="font-medium">{parentMessage.user.name}</span>
                  : &quot;{truncateText(parentMessage.description)}&quot;
                </div>
              )}
              ...
              {shouldReplyTruncate && (
                <button
                  ...
                  onClick={() => onToggleExpandSolution(reply.id)}
                >
                  ...
                  {reply.images.map((img) => (
                    ...
                    >
                      <Image
                        ...
                        alt={img.description || "Imagem da solução"}
                        className="h-32 w-auto rounded-lg border border-zinc-200 shadow-sm hover:brightness-90"
                        width={200}
                        height={128}
            ...
            <div className="flex gap-2 py-2">
              <Button
                ...
                onClick={() => onOpenSolutionModal("reply", reply)}
              >
                Responder
              </Button>
              {reply.isMine && (
                <>
                  <Button
                    ...
                    onClick={() => onOpenSolutionModal("edit", reply)}
                  >
                    Editar
                  </Button>
                  <Button
                    ...
                    onClick={() => onOpenDeleteSolutionDialog(reply)}
                  >
                    Excluir
                  </Button>
                </>
    ...
    return (
      <div className="flex w-full flex-col border-t border-zinc-200 p-8">
          ...
          <div>
            ...
            <div>
              <span className="text-sm text-zinc-500 dark:text-zinc-400">
                Nenhuma solução registrada para este problema
              </span>
            </div>
          </div>
          <Button
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <h4 className="mb-2 text-lg font-medium text-zinc-700 dark:text-zinc-300">
                ...
                <div className="flex flex-col">
                  <div className="flex flex-col">
                    ...
                    {shouldTruncate && (
                      <button
                        type="button"
                        className="text-xs text-blue-600 hover:underline mt-1 self-start"
                        onClick={() => onToggleExpandSolution(solution.id)}
                      >
                  ...
                  <div className="flex gap-1 py-2">
                    <Button
                      ...
                      style="unstyled"
                      className="py-2 text-blue-600 hover:bg-blue-100 hover:text-blue-800 focus:bg-blue-100 focus:text-blue-800 dark:text-blue-500 dark:hover:bg-blue-800/30 dark:hover:text-blue-400"
                      onClick={() => onOpenSolutionModal("reply", solution)}
                    >
                      Responder
                    </Button>
                    {solution.isMine && (
                      <>
                        <Button
                          ...
                          style="unstyled"
                          className="py-2 text-zinc-600 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-zinc-700 dark:hover:text-zinc-300"
                          onClick={() => onOpenSolutionModal("edit", solution)}
                        >
                          Editar
                        </Button>
                        <Button
                          ...
                          style="unstyled"
                          className="py-2 text-red-600 hover:bg-red-100 dark:text-red-400 dark:hover:bg-red-800/30 dark:hover:text-red-300"
                          onClick={() => onOpenDeleteSolutionDialog(solution)}
                        >
                          Excluir
                        </Button>
                      </>
