...
import { formatDate, formatDateBR } from "@/lib/date-utils";
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
              Filtros do Relatório de {getReportTypeLabel()}
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="block w-full rounded-lg py-3 px-4 border border-zinc-200 dark:border-zinc-700 dark:bg-zinc-900/30 dark:text-zinc-100 text-sm focus:ring-2 focus:ring-zinc-500 focus:border-zinc-500 transition-all duration-200 hover:border-zinc-300 dark:hover:border-zinc-600"
                />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center space-x-2">
