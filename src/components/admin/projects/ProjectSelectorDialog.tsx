...
export default function ProjectSelectorDialog({
  ...
  return (
    <Dialog
      ...
      description="Escolha um projeto para atribuir novos membros"
    >
          ...
          {filteredProjects.length === 0 ? (
            ...
            <div className="divide-y divide-zinc-200 dark:divide-zinc-700">
              {filteredProjects.map((project) => (
                <div
                  key={project.id}
                  className="p-4 cursor-pointer transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800"
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${project.status === "active" ? "bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400" : project.status === "completed" ? "bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400" : project.status === "paused" ? "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400" : "bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400"}`}
                        >
