...
export default function AuthImageSlider() {
  ...
  const slides = [
    {
      image: appConfig.getPublicPath("/images/slide-fundo-1.jpg"),
      alt: "Slide 1",
      title: "Gerencie todos os seus produtos em um só lugar",
    },
    {
      image: appConfig.getPublicPath("/images/slide-fundo-2.jpg"),
      alt: "Slide 2",
      title: "Controle total sobre processos e dependências",
    },
    {
      image: appConfig.getPublicPath("/images/slide-fundo-3.jpg"),
      alt: "Slide 3",
      title: "Colaboração eficiente entre equipes e projetos",
    },
    {
      image: appConfig.getPublicPath("/images/slide-fundo-4.jpg"),
      alt: "Slide 4",
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-24 left-0 right-0 z-10">
        <h1 className="text-center text-2xl antialiased italic text-white px-8">
      ...
      <div className="absolute bottom-12 left-1/2 z-10 flex -translate-x-1/2 space-x-2">
        {slides.map((_, index) => (
          <button
            ...
            className={`h-2 w-2 rounded-full transition-all duration-300 ${index === currentSlide ? "w-6 bg-white" : "bg-white/50 hover:bg-white/75"}`}
