export default function AuthHeader({
  ...
  return (
    <>
      ...
      <h1 className="text-center text-3xl font-bold tracking-tight text-zinc-600 dark:text-zinc-200">
        {title}
      </h1>
      <p className="mt-1 text-center text-base text-zinc-600 dark:text-zinc-200">
        {description}
      </p>
    </>
  );
