...
export default function InputPassword({
  ...
  const inputClasses = twMerge(
    clsx(
      "block w-full rounded-lg py-3 ps-4 pe-10 border disabled:pointer-events-none disabled:opacity-50",
  ...
  const buttonClasses = twMerge(
    clsx(
      "absolute inset-y-0 end-0 z-20 flex items-center pe-4 text-zinc-400 focus:outline-none rounded-e-md",
      isInvalid
