<script lang="ts">
	...
	// Classes Tailwind
	const turn = 'flex h-5 items-center justify-end pt-0.5 px-1.5 text-center text-xs font-bold text-zinc-400 dark:text-zinc-400'
	...
	const dayWeekNormal = 'flex h-5 w-5 items-center justify-center text-xs text-zinc-300 dark:text-zinc-500'
	const dayWeekWeekend = 'flex h-5 w-5 items-center justify-center text-xs text-zinc-400 dark:text-zinc-500'
	const dayNumber = 'flex h-5 w-5 items-center justify-center text-xs font-bold text-zinc-400 dark:text-zinc-400'
	...
	const monthName = 'flex h-5 w-20 items-center justify-end px-1.5 text-xs font-bold text-zinc-400 dark:text-zinc-400'
</script>
