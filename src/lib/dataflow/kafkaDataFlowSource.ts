...
import { createRestConsumer, deleteRestConsumer, fetchRecordsRest, subscribeRest } from "@/lib/kafkaRest";
import { DEFAULT_STATUS, type ProductStatus } from "@/lib/productStatus";
import { seedMonitoringProducts } from "@/lib/db/seedProducts";
