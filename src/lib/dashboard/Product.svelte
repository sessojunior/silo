	...
	<div class="mt-1.5 flex items-center justify-between">
		...
		<div class="hs-tooltip inline-block [--trigger:focus] sm:[--placement:top]">
			...
			<button type="button" class="hs-tooltip-toggle rounded-md bg-neutral-100 hover:bg-neutral-200 focus:bg-neutral-200 focus:outline-hidden dark:hover:bg-neutral-700">
				...
				<!-- Popover Content -->
				<div
					class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible invisible absolute z-[80] hidden rounded-xl border border-neutral-100 bg-white text-start opacity-0 shadow-md transition-opacity after:absolute after:-start-4 after:top-0 after:h-full after:w-4 dark:border-neutral-700 dark:bg-neutral-800"
					role="tooltip"
				>
					<div class="flex items-center justify-between border-b border-neutral-200 bg-neutral-50 px-4 py-3">
						...
						<div class="flex flex-col">
							...
							<div class="text-sm">Rodadas dos últimos dois meses</div>
						</div>
						<!-- Prioridade -->
