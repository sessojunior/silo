...
const google_callback = 'http://localhost:5173/sign-in/google/callback'
export const google = new Google(env.GOOGLE_CLIENT_ID, env.GOOGLE_CLIENT_SECRET, google_callback)
