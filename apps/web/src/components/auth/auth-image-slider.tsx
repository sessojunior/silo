...
export default function AuthImageSlider() {
  ...
  const slides = [
    {
      image: appConfig.getPublicPath("/images/bg-1.png"),
      alt: "Slide 1",
      title: "Gerencie todos os seus produtos em um só lugar",
    },
    {
      image: appConfig.getPublicPath("/images/bg-2.png"),
      alt: "Slide 2",
      title: "Controle total sobre processos e dependências",
    },
    {
      image: appConfig.getPublicPath("/images/bg-3.png"),
      alt: "Slide 3",
      title: "Colaboração eficiente entre equipes e projetos",
    },
    {
      image: appConfig.getPublicPath("/images/bg-4.png"),
      alt: "Slide 4",
