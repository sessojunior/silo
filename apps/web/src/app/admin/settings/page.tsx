...
export default function SettingsPage() {
  ...
  const fetchAllData = useCallback(async () => {
    ...
    try {
      ...
      const profileRes = await fetch(config.getApiUrl("/api/admin/users/profile"));
      ...
      const preferencesRes = await fetch(
        config.getApiUrl("/api/admin/users/preferences"),
      );
      ...
      console.error("❌ [PAGE_SETTINGS] Erro ao carregar dados do usuário:", {
        error,
      });
      toast({
        type: "error",
  ...
  const handleUpdatePreferences = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(config.getApiUrl("/api/admin/users/preferences"), {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
      ...
      console.error("❌ [PAGE_SETTINGS] Erro ao atualizar preferências:", {
        error,
      });
      toast({
        type: "error",
  ...
  const handleUpdateEmail = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(config.getApiUrl("/api/admin/users/email-change"), {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      if (!res.ok) {
        ...
        toast({
          ...
          description:
            "Um código de verificação foi enviado para o novo e-mail.",
        });
      }
    } catch (error) {
      console.error(
        "❌ [PAGE_SETTINGS] Erro ao solicitar alteração de email:",
        { error },
      );
      toast({
        type: "error",
  ...
  const handleConfirmEmailChange = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(
        "❌ [PAGE_SETTINGS] Erro ao confirmar alteração de email:",
        { error },
      );
      toast({
        type: "error",
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          Altere suas informações pessoais, como nome, função, celular, equipe e
          foto de perfil.
        </p>
      </div>
  ...
  const renderPreferencesContent = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          Configure suas preferências de notificações e comunicações do sistema.
        </p>
      </div>
      ...
      <form onSubmit={handleUpdatePreferences} className="space-y-6">
        <fieldset className="space-y-6" disabled={loadingPreferences}>
          <Switch
            ...
            size="lg"
            title="Exibir página de boas-vindas"
            description="Mostrar a página de boas-vindas na próxima vez que você acessar o sistema."
          />
          ...
          <Switch
            ...
            description="Permitir o uso do sistema de chat e notificações em tempo real. Desativar reduz o consumo de banco de dados."
          />
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400">
            Altere seu e-mail de acesso ao sistema. Um código de confirmação
            será enviado para o novo e-mail.
          </p>
        </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-800 dark:text-blue-200">
                      ...
                      <strong>{emailChangeNewEmail}</strong>. Digite o código
                      abaixo para confirmar a alteração do seu e-mail.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1 list-disc list-inside">
              <li>
                Ao alterar seu e-mail, um e-mail de confirmação será enviado
              </li>
