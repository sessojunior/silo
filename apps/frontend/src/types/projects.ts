...
import type {
  ...
  ProjectTaskDto,
  ProjectTaskUserDto,
  ProjectTaskHistoryDto,
} from "@silo/engine/contracts/dto/projects";

// === TIPOS BASE (do contracts) ===

export type Project = ProjectDto;
export type ProjectActivity = ProjectActivityDto;
export type ProjectTask = ProjectTaskDto;
export type ProjectTaskUser = ProjectTaskUserDto;
export type ProjectTaskHistory = ProjectTaskHistoryDto;
