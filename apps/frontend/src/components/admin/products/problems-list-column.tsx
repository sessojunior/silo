...
import type { ProductProblemDto as ProductProblem } from "@silo/engine/contracts/dto/products";
...
export function ProblemsListColumn({
  listRef,
  filter,
  setFilter,
  onAddProblem,
...
function ListProblems({
  ...
  solutionsCount: Record<string, number>;
  onSelect: (problem: ProductProblemWithCategory) => void;
              ...
              {problem.categoryName && (
                <div className="mb-1">
                  <span
                    ...
                    style={{
                      backgroundColor: problem.categoryColor
                        ? `${problem.categoryColor}20`
                        : "#6b728020",
                      color: problem.categoryColor || "#6b7280",
                      borderColor: problem.categoryColor
                        ? `${problem.categoryColor}40`
                        : "#6b728040",
                    }}
                  >
                    {problem.categoryName}
