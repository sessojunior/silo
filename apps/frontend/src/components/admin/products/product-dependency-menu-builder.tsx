...
import {
  type TreeItemType,
  type MenuItemData,
} from "@/components/ui/menu-builder-types";
...
export default function ProductDependencyMenuBuilder({
  style = "bordered",
  items: itemsProps,
  setItems,
  onEdit,
  onDelete,
}: ProductDependencyProps) {
  ...
  function convertProductDependencyToTreeItems(
    items: ProductDependencyItem[],
  ): TreeItemType[] {
  ...
  function convertTreeItemsToProductDependency(
    items: TreeItemType[],
  ...
  function findOriginalItem(
    id: UniqueIdentifier,
    items: ProductDependencyItem[],
  ): ProductDependencyItem | undefined {
