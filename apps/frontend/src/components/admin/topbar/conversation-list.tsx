...
import { formatDateTimeBR } from "@silo/engine/date";
                    ...
                    {conversation.unreadCount > 3 && (
                      <div className="flex items-center justify-start py-1">
                        <div className="flex items-center justify-center gap-2 bg-zinc-100 dark:bg-zinc-700 px-3 py-1 rounded-full">
                          <span className="text-xs text-zinc-500 dark:text-zinc-400">
                            +{conversation.unreadCount - 3}{" "}
                            {conversation.unreadCount - 3 === 1
                              ? "mensagem anterior não lida"
                              : "mensagens anteriores não lidas"}
                          </span>
                        </div>
                        <div className="flex-1 mx-2 h-px bg-linear-to-r from-zinc-300 to-transparent dark:from-zinc-600"></div>
                      </div>
                    )}
