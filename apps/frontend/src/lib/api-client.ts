/**
 * api-client.ts — Cliente HTTP enxuto para chamadas server-side ao backend Python.
 *
 * Use este arquivo em Server Components e Server Actions que precisam falar com o backend Python.
